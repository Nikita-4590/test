    ...
    <div id="search-form">
        <form id="search-relation-request-form">
            <div id="status_search_form">
                ...
                <select id="status_select_option" class="status_combobox_search">
                    <option value=""></option>
            ...
            <div class="free_text_search_form">
                ...
                <input type="submit" id="button_search" class="button orange wrapper_button_search" value="検索"/>
            </div>
        </form>
    </div>
</div>
<div id="company-list-page-table">

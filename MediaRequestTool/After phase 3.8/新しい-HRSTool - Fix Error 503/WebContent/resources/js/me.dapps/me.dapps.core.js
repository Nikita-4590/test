...
//check referrer
window.isReferrer = function() {
	var currentPath = window.location.protocol +'//' + window.location.hostname;
	return isSet(document.referrer) && document.referrer.indexOf(currentPath) == 0 ? true : false;
};
